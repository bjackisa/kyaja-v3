    ...
    <div className="relative w-full bg-gradient-to-r from-black via-neutral-900 to-black border-b border-orange-500/20">
      <div className="relative flex items-center px-4 py-4">
        ...
        {showLeftArrow && (
          <button
            onClick={() => scroll('left')}
            className="absolute left-2 z-20 hidden h-10 w-10 items-center justify-center rounded-full bg-black/80 backdrop-blur-sm border border-orange-500/30 text-orange-500 shadow-lg shadow-orange-500/20 transition-all hover:bg-orange-500 hover:text-black hover:scale-110 hover:shadow-orange-500/40 md:flex"
          ...
          >
            {departments.map((category, i) => (
              <Link
                ...
                className="group relative px-4 py-2 text-sm font-medium text-white/90 transition-all hover:text-orange-500 whitespace-nowrap"
              >
        ...
        {showRightArrow && (
          <button
            ...
            className="absolute right-2 z-20 hidden h-10 w-10 items-center justify-center rounded-full bg-black/80 backdrop-blur-sm border border-orange-500/30 text-orange-500 shadow-lg shadow-orange-500/20 transition-all hover:bg-orange-500 hover:text-black hover:scale-110 hover:shadow-orange-500/40 md:flex"
